...
export const sendConfirmEmail = async (
  ...
  const mailOptions = {
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; max-width: 600px; margin: auto; border: 1px solid #eaeaea; padding: 20px; border-radius: 8px;">
      <h1 style="color: #4CAF50; text-align: center;">예약이 확정되었습니다!</h1>
      <p style="font-size: 1.2em;">안녕하세요, 고객님!</p>
      <p>FGFG 서비스 예약이 확정 되었습니다. 가이드와 멋진 하루를 즐기시길 바랍니다!</p>
     ...
     <div style="text-align: center; margin-top: 20px;">
      ...
      <div style="border-top: 1px solid #eaeaea; padding-top: 10px; margin-top: 20px;">
        <h2 style="color: #4CAF50;">예약 정보</h2>
      ...
      <div style="margin-top: 30px; text-align: center;">
        <a href="https://fgfg.com" style="background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-weight: bold;">FGFG로 이동하기</a>
      </div>
