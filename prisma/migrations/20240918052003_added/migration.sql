...
INSERT INTO "new_Message" ("chatRoomId", "created_at", "guideId", "id", "payload", "updated_at", "userId") SELECT "chatRoomId", "created_at", "guideId", "id", "payload", "updated_at", "userId" FROM "Message";
DROP TABLE "Message";
