...
INSERT INTO "new_File" ("createdAt", "fileUrl", "fileUrlOrder", "guideProfileId", "id", "updatedAt") SELECT "createdAt", "fileUrl", "fileUrlOrder", "guideProfileId", "id", "updatedAt" FROM "File";
DROP TABLE "File";
