/*
  ...
  - Made the column `pickupPlaceDetail` on table `Guide` required. This step will fail if there are existing NULL values in that column.
...
CREATE TABLE "new_Guide" (
    ...
    "pickupPlaceDetail" TEXT NOT NULL,
